...
import { fetchAndPrepareMarketData, extractAvailableCategories, type MarketItem, type MarketDataset, type MasterCatalogItem } from '../services/marketDataService';
...
import { getOrComputeDailyTrend, filterAndSortMarketItems } from '../boxes/market/marketUtils';
