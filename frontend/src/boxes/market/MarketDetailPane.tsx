                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    {onRetry && (
                      <button
                        ...
                        title={isJustRefreshed ? "最新APIから更新完了！" : "出品情報を再取得 (リフレッシュ)"}
                        style={{
                          padding: '4px 8px',
                          fontSize: '0.72rem',
                          borderRadius: '6px',
                          cursor: loadingListings ? 'not-allowed' : 'pointer',
                          background: isJustRefreshed ? 'rgba(74, 222, 128, 0.15)' : 'rgba(0,0,0,0.4)',
                          border: isJustRefreshed ? '1px solid #4ade80' : '1px solid rgba(255,255,255,0.08)',
                          color: isJustRefreshed ? '#4ade80' : (loadingListings ? '#00d2ff' : '#94a3b8'),
                          transition: 'all 0.2s ease',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          height: '27px',
                          gap: isJustRefreshed ? '4px' : '0',
                        }}
                        onMouseEnter={(e) => {
                          if (!loadingListings && !isJustRefreshed) {
                      ...
                      >
                        {isJustRefreshed ? (
                          <>
                            <i className="fa-solid fa-check" style={{ color: '#4ade80' }}></i>
                            <span style={{ fontSize: '0.65rem', fontWeight: 700 }}>更新済</span>
                          </>
                        ) : (
